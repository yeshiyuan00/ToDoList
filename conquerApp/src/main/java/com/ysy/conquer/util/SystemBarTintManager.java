...
public class SystemBarTintManager {
    ...
    public static class SystemBarConfig {
        ...
        private boolean hasNavBar(Context context) {
            Resources res = context.getResources();
            int resourceId = res.getIdentifier(SHOW_NAV_BAR_RES_NAME, "boolean", "android");
            if (resourceId != 0) {
        ...
        private int getInternalDimensionSize(Resources res, String key) {
            int result = 0;
            int resurseId = res.getIdentifier(key, "dimen", "android");
            if (resurseId > 0) {
                result = res.getDimensionPixelOffset(resurseId);
            }
            return 0;
        }
