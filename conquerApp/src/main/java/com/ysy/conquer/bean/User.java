...
public class User extends BmobChatUser{
    ...
    public String toString() {
        return "User [isMale=" + isMale + ", username=" + getUsername() + "," +
                " nick=" + getNick() + ", sign=" + sign + ", city=" + city + "," +
                " school=" + school + ", dep=" + dep + ", major=" + major
                + ", year=" + year + ", phoneNum=" + phoneNum + ", loveStatus=" +
                loveStatus + ", label=" + label + ", album=" + album
                + ", sortLetters=" + sortLetters + ", location=" + location + ", " +
                "homeBg=" + homeBg + "]";
    }
